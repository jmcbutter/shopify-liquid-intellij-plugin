...
public class ShopifyLiquidEndcommentTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidEndcommentTag {

  public ShopifyLiquidEndcommentTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitEndcommentTag(this);
  }
