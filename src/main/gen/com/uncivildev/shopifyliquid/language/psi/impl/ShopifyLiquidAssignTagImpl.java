...
public class ShopifyLiquidAssignTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidAssignTag {

  public ShopifyLiquidAssignTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitAssignTag(this);
  }
