...
public class ShopifyLiquidFilterImpl extends ASTWrapperPsiElement implements ShopifyLiquidFilter {

  public ShopifyLiquidFilterImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public ShopifyLiquidFilterArguments getFilterArguments() {
    return findChildByClass(ShopifyLiquidFilterArguments.class);
  }
