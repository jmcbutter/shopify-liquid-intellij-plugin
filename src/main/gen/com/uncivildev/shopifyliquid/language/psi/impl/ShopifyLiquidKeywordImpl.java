...
public class ShopifyLiquidKeywordImpl extends ASTWrapperPsiElement implements ShopifyLiquidKeyword {

  public ShopifyLiquidKeywordImpl(@NotNull ASTNode node) {
    super(node);
  }
