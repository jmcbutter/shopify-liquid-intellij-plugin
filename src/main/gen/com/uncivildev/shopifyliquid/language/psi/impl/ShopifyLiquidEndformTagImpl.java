...
public class ShopifyLiquidEndformTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidEndformTag {

  public ShopifyLiquidEndformTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitEndformTag(this);
  }
