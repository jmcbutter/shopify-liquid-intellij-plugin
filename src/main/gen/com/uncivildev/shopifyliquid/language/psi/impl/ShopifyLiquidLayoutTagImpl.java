...
public class ShopifyLiquidLayoutTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidLayoutTag {

  public ShopifyLiquidLayoutTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitLayoutTag(this);
  }
