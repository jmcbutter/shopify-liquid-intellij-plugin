...
public class ShopifyLiquidIfchangedTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidIfchangedTag {

  public ShopifyLiquidIfchangedTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitIfchangedTag(this);
  }
