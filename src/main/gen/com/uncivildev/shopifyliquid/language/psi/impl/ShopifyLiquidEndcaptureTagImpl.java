...
public class ShopifyLiquidEndcaptureTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidEndcaptureTag {

  public ShopifyLiquidEndcaptureTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitEndcaptureTag(this);
  }
