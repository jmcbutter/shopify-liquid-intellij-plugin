...
public class ShopifyLiquidEndpaginateTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidEndpaginateTag {

  public ShopifyLiquidEndpaginateTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitEndpaginateTag(this);
  }
