...
public class ShopifyLiquidEndforTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidEndforTag {

  public ShopifyLiquidEndforTagImpl(@NotNull ASTNode node) {
    super(node);
  }
