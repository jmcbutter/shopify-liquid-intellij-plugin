...
public class ShopifyLiquidLiquidOutputImpl extends ASTWrapperPsiElement implements ShopifyLiquidLiquidOutput {

  public ShopifyLiquidLiquidOutputImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitLiquidOutput(this);
  }
  ...
  @Override
  @NotNull
  public ShopifyLiquidOutputContent getOutputContent() {
    return findNotNullChildByClass(ShopifyLiquidOutputContent.class);
  }
