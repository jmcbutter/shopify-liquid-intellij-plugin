...
public class ShopifyLiquidContinueTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidContinueTag {

  public ShopifyLiquidContinueTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitContinueTag(this);
  }
