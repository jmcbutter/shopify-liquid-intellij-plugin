...
public class ShopifyLiquidEndcaseTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidEndcaseTag {

  public ShopifyLiquidEndcaseTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitEndcaseTag(this);
  }
