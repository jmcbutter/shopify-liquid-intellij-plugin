...
public class ShopifyLiquidLiquidTagKwImpl extends ASTWrapperPsiElement implements ShopifyLiquidLiquidTagKw {

  public ShopifyLiquidLiquidTagKwImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitLiquidTagKw(this);
  }
