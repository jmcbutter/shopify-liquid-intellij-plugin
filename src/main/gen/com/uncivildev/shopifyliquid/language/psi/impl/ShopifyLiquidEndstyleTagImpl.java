...
public class ShopifyLiquidEndstyleTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidEndstyleTag {

  public ShopifyLiquidEndstyleTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitEndstyleTag(this);
  }
