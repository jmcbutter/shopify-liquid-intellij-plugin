...
public class ShopifyLiquidStyleTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidStyleTag {

  public ShopifyLiquidStyleTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitStyleTag(this);
  }
