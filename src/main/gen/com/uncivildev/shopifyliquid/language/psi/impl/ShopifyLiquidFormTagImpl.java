...
public class ShopifyLiquidFormTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidFormTag {

  public ShopifyLiquidFormTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitFormTag(this);
  }
