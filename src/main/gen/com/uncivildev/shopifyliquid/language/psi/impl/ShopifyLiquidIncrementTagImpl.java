...
public class ShopifyLiquidIncrementTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidIncrementTag {

  public ShopifyLiquidIncrementTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitIncrementTag(this);
  }
  ...
  public ShopifyLiquidVariableLookup getVariableLookup() {
    return findNotNullChildByClass(ShopifyLiquidVariableLookup.class);
  }
