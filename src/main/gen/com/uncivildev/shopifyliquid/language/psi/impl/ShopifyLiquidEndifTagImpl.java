...
public class ShopifyLiquidEndifTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidEndifTag {

  public ShopifyLiquidEndifTagImpl(@NotNull ASTNode node) {
    super(node);
  }
