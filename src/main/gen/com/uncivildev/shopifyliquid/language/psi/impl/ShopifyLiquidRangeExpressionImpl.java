...
public class ShopifyLiquidRangeExpressionImpl extends ASTWrapperPsiElement implements ShopifyLiquidRangeExpression {

  public ShopifyLiquidRangeExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
