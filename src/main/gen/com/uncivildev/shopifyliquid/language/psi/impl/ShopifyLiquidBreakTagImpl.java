...
public class ShopifyLiquidBreakTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidBreakTag {

  public ShopifyLiquidBreakTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitBreakTag(this);
  }
