...
public class ShopifyLiquidEndrawTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidEndrawTag {

  public ShopifyLiquidEndrawTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitEndrawTag(this);
  }
