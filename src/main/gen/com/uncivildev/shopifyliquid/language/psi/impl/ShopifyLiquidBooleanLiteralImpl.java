...
public class ShopifyLiquidBooleanLiteralImpl extends ASTWrapperPsiElement implements ShopifyLiquidBooleanLiteral {

  public ShopifyLiquidBooleanLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
