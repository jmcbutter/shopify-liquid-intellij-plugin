...
public class ShopifyLiquidLiteralImpl extends ASTWrapperPsiElement implements ShopifyLiquidLiteral {

  public ShopifyLiquidLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public ShopifyLiquidBooleanLiteral getBooleanLiteral() {
    return findChildByClass(ShopifyLiquidBooleanLiteral.class);
  }
