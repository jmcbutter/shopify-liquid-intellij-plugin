...
public class ShopifyLiquidSchemaTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidSchemaTag {

  public ShopifyLiquidSchemaTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitSchemaTag(this);
  }
