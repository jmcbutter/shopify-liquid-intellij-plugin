...
public class ShopifyLiquidConditionImpl extends ASTWrapperPsiElement implements ShopifyLiquidCondition {

  public ShopifyLiquidConditionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public ShopifyLiquidComparisonOperator getComparisonOperator() {
    return findChildByClass(ShopifyLiquidComparisonOperator.class);
  }
