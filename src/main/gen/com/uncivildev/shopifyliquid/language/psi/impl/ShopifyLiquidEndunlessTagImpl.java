...
public class ShopifyLiquidEndunlessTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidEndunlessTag {

  public ShopifyLiquidEndunlessTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitEndunlessTag(this);
  }
