...
public class ShopifyLiquidComparisonOperatorImpl extends ASTWrapperPsiElement implements ShopifyLiquidComparisonOperator {

  public ShopifyLiquidComparisonOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
