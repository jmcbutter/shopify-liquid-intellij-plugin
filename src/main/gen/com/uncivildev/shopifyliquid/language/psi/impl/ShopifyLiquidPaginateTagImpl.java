...
public class ShopifyLiquidPaginateTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidPaginateTag {

  public ShopifyLiquidPaginateTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitPaginateTag(this);
  }
