...
public class ShopifyLiquidElseTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidElseTag {

  public ShopifyLiquidElseTagImpl(@NotNull ASTNode node) {
    super(node);
  }
