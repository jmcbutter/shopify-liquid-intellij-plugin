...
public class ShopifyLiquidCaseTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidCaseTag {

  public ShopifyLiquidCaseTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitCaseTag(this);
  }
