...
public class ShopifyLiquidStylesheetTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidStylesheetTag {

  public ShopifyLiquidStylesheetTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitStylesheetTag(this);
  }
