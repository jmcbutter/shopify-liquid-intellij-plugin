...
public class ShopifyLiquidEndtablerowTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidEndtablerowTag {

  public ShopifyLiquidEndtablerowTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitEndtablerowTag(this);
  }
