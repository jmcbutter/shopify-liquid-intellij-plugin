...
public class ShopifyLiquidLiquidTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidLiquidTag {

  public ShopifyLiquidLiquidTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitLiquidTag(this);
  }
  ...
  @Override
  @NotNull
  public ShopifyLiquidTagContent getTagContent() {
    return findNotNullChildByClass(ShopifyLiquidTagContent.class);
  }
