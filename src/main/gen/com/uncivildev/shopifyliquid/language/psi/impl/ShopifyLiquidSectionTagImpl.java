...
public class ShopifyLiquidSectionTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidSectionTag {

  public ShopifyLiquidSectionTagImpl(@NotNull ASTNode node) {
    super(node);
  }
