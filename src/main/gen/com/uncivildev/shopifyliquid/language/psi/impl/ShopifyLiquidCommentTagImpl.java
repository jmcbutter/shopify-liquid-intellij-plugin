...
public class ShopifyLiquidCommentTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidCommentTag {

  public ShopifyLiquidCommentTagImpl(@NotNull ASTNode node) {
    super(node);
  }
