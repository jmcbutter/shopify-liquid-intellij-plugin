...
public class ShopifyLiquidWhenTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidWhenTag {

  public ShopifyLiquidWhenTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitWhenTag(this);
  }
  ...
  @Override
  @NotNull
  public List<ShopifyLiquidValue> getValueList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ShopifyLiquidValue.class);
  }
