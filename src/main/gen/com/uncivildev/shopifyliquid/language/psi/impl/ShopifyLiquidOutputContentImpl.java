...
public class ShopifyLiquidOutputContentImpl extends ASTWrapperPsiElement implements ShopifyLiquidOutputContent {

  public ShopifyLiquidOutputContentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitOutputContent(this);
  }
  ...
  public ShopifyLiquidExpression getExpression() {
    return findNotNullChildByClass(ShopifyLiquidExpression.class);
  }
