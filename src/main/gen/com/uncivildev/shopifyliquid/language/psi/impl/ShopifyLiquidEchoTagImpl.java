...
public class ShopifyLiquidEchoTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidEchoTag {

  public ShopifyLiquidEchoTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitEchoTag(this);
  }
