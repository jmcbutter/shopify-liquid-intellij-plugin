...
public class ShopifyLiquidSectionsTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidSectionsTag {

  public ShopifyLiquidSectionsTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitSectionsTag(this);
  }
