...
public class ShopifyLiquidEndjavascriptTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidEndjavascriptTag {

  public ShopifyLiquidEndjavascriptTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitEndjavascriptTag(this);
  }
