...
public class ShopifyLiquidUnlessTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidUnlessTag {

  public ShopifyLiquidUnlessTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitUnlessTag(this);
  }
  ...
  @Override
  @NotNull
  public ShopifyLiquidCondition getCondition() {
    return findNotNullChildByClass(ShopifyLiquidCondition.class);
  }
