...
public class ShopifyLiquidRawTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidRawTag {

  public ShopifyLiquidRawTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitRawTag(this);
  }
