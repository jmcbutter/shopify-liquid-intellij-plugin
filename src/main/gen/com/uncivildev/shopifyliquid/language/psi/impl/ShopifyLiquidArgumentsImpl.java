...
public class ShopifyLiquidArgumentsImpl extends ASTWrapperPsiElement implements ShopifyLiquidArguments {

  public ShopifyLiquidArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }
