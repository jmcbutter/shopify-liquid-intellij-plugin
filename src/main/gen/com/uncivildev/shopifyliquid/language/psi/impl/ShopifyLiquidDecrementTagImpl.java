...
public class ShopifyLiquidDecrementTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidDecrementTag {

  public ShopifyLiquidDecrementTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitDecrementTag(this);
  }
