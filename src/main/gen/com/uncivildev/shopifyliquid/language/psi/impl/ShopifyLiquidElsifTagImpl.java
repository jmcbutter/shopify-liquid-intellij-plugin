...
public class ShopifyLiquidElsifTagImpl extends ASTWrapperPsiElement implements ShopifyLiquidElsifTag {

  public ShopifyLiquidElsifTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ShopifyLiquidVisitor visitor) {
    visitor.visitElsifTag(this);
  }
